...
#define BotonMenu_Pin	((uint8_t) 3)

#define BotonOk_Port	((uint8_t) 0)
#define BotonOk_Pin		((uint8_t) 21)

#define BotonUp_Port	((uint8_t) 0)
#define BotonUp_Pin		((uint8_t) 27)
#define BotonDown_Port	((uint8_t) 0)
#define BotonDown_Pin	((uint8_t) 28)
...
/* =GPIO= */
	...
	//Semforos
	vSemaphoreCreateBinary(SemBotonPresionado);
	xSemaphoreTake(SemBotonPresionado , portMAX_DELAY );
}

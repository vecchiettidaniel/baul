...
int main (int argc, char **argv)
{
	...
	mi_memoria=shmget(mi_key,sizeof(struct dato_memoria),IPC_CREAT|660);
	if(mi_memoria==-1)
	{
    ...
    printf("Semaforos creados e inicializados\n");
    ...
    printf("Leyendo del sensor cada %d segundos\n",atoi(*(argv+1)));
	while(1)
	{
